...
const InboxContent = () => {
  ...
  return (
    ...
    />
<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" className='search-icon'  stroke="currentColor">
  <g opacity="0.5">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.69366 12.4863C12.4235 11.3261 13.696 8.17265 12.5358 5.44282C11.3757 2.71298 8.22221 1.4405 5.49237 2.60065C2.76253 3.7608 1.49005 6.91426 2.6502 9.6441C3.81036 12.3739 6.96382 13.6464 9.69366 12.4863Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M11.3904 11.3407L15.5557 15.5066" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
</svg>
  </div>
